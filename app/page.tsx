...
<div style={{ border: "1px solid #8fa1b7", borderRadius: "8px", overflowX: "auto", overflowY: "visible", maxHeight: "78vh", backgroundColor: "#fff", boxShadow: "0 1px 3px rgba(0,0,0,0.06)", margin: "0 6px" }}>
